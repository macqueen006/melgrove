...
const IntroOverlay = () => {
    return <>
        <div className="intro-overlay relative block min-h-full">
            <div className="top h-[50dvh] landscape:h-dvh absolute w-full z-20">
            ...
            <div className="bottom h-[50dvh] absolute w-full z-20 bottom-0">
